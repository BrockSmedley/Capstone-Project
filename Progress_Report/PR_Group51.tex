...
\begin{tabular}{|p{0.3\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
   ...
   & 
   Nothing needed to be change before the first meeting, the group would have the outline 
...
\begin{tabular}{|p{0.3\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
   ...
   the range was too broad to research on since the group had seldom experiences on hardware. 
   Therefore, the research range was expected to be focused on specific hardware.
   & 
   The TA Lin suggested to have carrier board research based on NVIDIA Jetson TX1 and TX2 at beginning, so the group was able to be familiar with the system of the application. \\
   \hline
\end{tabular}
