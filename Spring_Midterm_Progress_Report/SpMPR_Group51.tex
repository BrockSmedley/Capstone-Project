...
a GStreamer plugin \testtt{nvcamerasrc}, and the OpenCV stitcher class and function. 
...
\paragraph*{nvcamerasrc} The GStreamer plugin \testtt{nvcamerasrc} is designed to deliver 
the video stream to our image processing software, and may not be suitable for 
high-bandwidth processing. The \testtt{nvcamerasrc} plugin offers Image Signal Processor 
...
In Figure 1 we see an alternatives, the \testtt{v4l2src} GStreamer plugin. The 
