...
a host laptop we experienced \textt{WARNING: root device  does not exist} multiple times
...
using \textt{v4l2src} and RAW10 but we continued to be unsuccessful at producing any type 
of video output. \\
...
\textt{gst-launch-1.0 nvcamerasrc ! 'video/x-raw(memory:NVMM),width=640, height=480, framerate=30/1, format=NV12' ! nvvidconv flip-method=2 ! nvegltransform ! nveglglessink -e} \\
